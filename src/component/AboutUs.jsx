...
const AboutUs = () => {
  return (
    <div className="about-container">
      ...
      <p>
        At WTL Tourism Private Limited, we specialize in providing seamless, reliable, and efficient corporate and rental cab service across India. With a fleet of well-maintained vehicles, professional drivers, and state-of-the-art GPS tracking, we ensure a smooth and safe journey every time.

        Our services include:
        • Corporate Cab Solutions: Flexible transport for employees and executives.
        • Car Rentals: Convenient and customizable options for short and long-term needs.
        • PAN India Coverage: Reliable services in all major cities, ensuring consistency and quality.

        <br />
        <br />
        What sets us apart?
        <br />
        ✅ Timely Service – Punctuality is our promise.
        <br />
        ✅ Customized Solutions – Our in-house app offers tailored features for corporate clients.
        <br />
        ✅ 24/7 Support – Round-the-clock assistance for all your transport needs.

        <br />
        <br />
        At WTL, we don’t just drive people—we drive trust and satisfaction.
      </p>
